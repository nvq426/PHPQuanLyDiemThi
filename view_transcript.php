...
<body>
    ...
    <div class="content">
        ...
        <p><strong>Mã SV:</strong> <?php echo htmlspecialchars($studentInfo['studentID']); ?></p>
        ...
        <p><strong>Điểm trung bình:</strong> <?php echo htmlspecialchars($transcript['averageScore']); ?></p>
