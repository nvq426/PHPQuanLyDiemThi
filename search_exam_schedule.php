...
// Xử lý tra cứu lịch thi
$whereClause = [];
$filters = [];
if ($_SESSION['role'] === 'student') {
    // Sinh viên chỉ tra cứu lịch thi của mình
    $whereClause[] = "ExamSchedule_Student.studentID = :studentID";
    $filters[':studentID'] = $_SESSION['userID'];
} else {
    // Giáo viên tra cứu lịch coi thi của mình
    $whereClause[] = "(ExamSchedules.teacherID1 = :teacherID OR ExamSchedules.teacherID2 = :teacherID)";
    $filters[':teacherID'] = $_SESSION['userID'];
}
...
if (isset($_GET['exam_date_filter']) && $_GET['exam_date_filter'] != '') {
    $whereClause[] = "ExamSchedules.examDate = :examDate";
    $filters[':examDate'] = $_GET['exam_date_filter'];
}
...
if ($_SESSION['role'] === 'student') {
    $query .= " JOIN ExamSchedule_Student ON ExamSchedules.scheduleID = ExamSchedule_Student.scheduleID";
}
...
<body>
    ...
    <div class="header">
        <h2><?php echo $_SESSION['role'] === 'teacher' ? 'Giáo viên' : 'Sinh viên'; ?></h2>
        <ul>
            ...
            <?php else: ?>
                ...
                <li>
                    <a href="search_average_score.php">
                        ...
                        <span class="tab-label">Tra cứu Điểm Trung bình</span>
                    </a>
                </li>
                <li>
                    <a href="view_transcript.php">
    ...
    <div class="content">
        ...
        <div class="filters">
            <form class="filter-group" action="search_exam_schedule.php" method="get">
                ...
                <input type="date" name="exam_date_filter" value="<?php echo isset($_GET['exam_date_filter']) ? htmlspecialchars($_GET['exam_date_filter']) : ''; ?>">
        ...
        <table>
            ...
            <tbody>
                <?php if (!$result): ?>
                    <tr>
                        <td colspan="7">Không có dữ liệu lịch thi.</td>
                    </tr>
                <?php else: ?>
